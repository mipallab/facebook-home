          ...
          <div class="user-menu-box">
            <div class="user-data-box">
              <div class="user-data-box-item">
                <img src="<?php echo  $myProfile['photo']; ?>" alt="" />
                <span><?php echo  $myProfile['name']; ?></span>
              </div>
          ...
          <div class="story-box-body">
            <div class="story-area">
              <div class="story-item auth-user-story"
                style="background-image: url('<?php echo $story_area['user_stry_photo']; ?>')">
              ...
              <?php foreach ($story_area['frnd_story'] as $story): ?>
                <div class="story-item" style="background-image: url('<?php echo $story['frnd_stry_pic']; ?>');
                  ">
                  <div class="story-user">
                    <img src="<?php echo $story['frnd_pro_pic']; ?>" alt="" />
                  </div>
                  <span><?php echo $story['frnd_name']; ?></span>
                </div>
              <?php endforeach; ?>
        ...
        <?php foreach ($timeline as $user) : ?>
          <div class="user-post">
            <div class="user-post-header">
              <div class="post-info">
                <img src="<?php echo $user['user_img']; ?>" alt="" />
                <div class="user-details">
                  <a class="author" href="#"><?php echo $user['user_name']; ?></a>
                  <span><?php echo timeAgo($user['post_time']); ?>
                    <svg fill="currentColor" viewBox="0 0 16 16" width="1em" height="1em"
            ...
            <div class="post-body">
              <div class="post-content">
                <p>
                  <?php echo $user['user_post']['test']; ?>
                </p>
              </div>
            </div>
            <div class="post-media">
              <img src="<?php echo $user['user_post']['photo']; ?>" alt="" />
            </div>
